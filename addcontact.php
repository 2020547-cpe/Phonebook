...
$connection = new mysqli($servername, $username, $password, $database);
    ...
    if($_SERVER['REQUEST_METHOD']== 'POST'){
        ...
        do{
            if (empty($username) || empty($phone) || empty($email)|| empty($address)|| empty($notes)){
                $errorMessage = "All the fields are required";
                break;
            }

            $sql = "INSERT INTO kphone (username, phone, email, address, notes)".
                "VALUES ('$username', '$phone','$email', '$address', '$notes' )";
...
<head>
    ...
    <title>Add Contact List</title>
</head>
<body>
<div id="center-overlay">
        <img src="lpg.png" alt="Center Overlay Image">
    </div>
